...
function ForterCustomerAccount(eventType, request, customer) {
    function ForterConnectionInformation() {
        this.customerIP = forterForceForterDecision !== 'DISABLED' ? forterForceForterDecision : request.httpRemoteAddress;     // Required
    ...
    function additionalFields(typeEvent, forterCustomerAccount) {
        switch (typeEvent) {
