        ...
        for (var i = 0; i < paymentInstruments.length; i++) {
            ...
            if (PaymentMgr.getPaymentMethod(paymentInstrument.getPaymentMethod()).getPaymentProcessor() === null) {
                ...
                if (authorizationResult.not_supported || authorizationResult.error) {
                    return {
                        error: true,
                        errorMessage: !empty(authorizationResult.forterErrorCode) ? authorizationResult.forterErrorCode.code : 'confirm.error.technical'
                    };
                }
            }
        }
...
function start() {
    ...
    // };
    // var forterCall       = require('*/cartridge/controllers/ForterValidate');
    ...
    if (handlePaymentsResult.error) {
        return Transaction.wrap(function () {
            ...
            return {
                error: true,
                PlaceOrderError: new Status(Status.ERROR, handlePaymentsResult.errorMessage)
            };
        });
